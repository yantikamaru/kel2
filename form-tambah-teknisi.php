    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <form class="form-horizontal" method="POST" action="proses-simpan-teknisi.php">
            <div class="form-group">
              <label class="col-sm-2 control-label">Id_teknisi</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" name="id_teknisi" maxlength="5" autocomplete="off" required>
              </div>
            </div>
